...
$lang->action->label->leave['reported'] = '銷假審核|leave|browsereview|';
...
$lang->action->label->makeup['created']  = '補班審核|makeup|browsereview|';
$lang->action->label->makeup['commited'] = '補班審核|makeup|browsereview|';
$lang->action->label->makeup['revoked']  = '補班審核|makeup|browsereview|';
$lang->action->label->makeup['reviewed'] = '補班審核|makeup|personal|';
